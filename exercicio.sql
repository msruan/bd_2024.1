...
SELECT F.NOME
FROM HOSPEDE NATURAL JOIN HOSPEDAGEM 
JOIN FUNCIONARIO F ON HOSPEDAGEM.COD_FUNC = F.COD_FUNC
WHERE HOSPEDE.NOME ILIKE 'JOÃO%'

UNION

SELECT F.NOME
FROM HOSPEDE NATURAL JOIN RESERVA
JOIN FUNCIONARIO F ON RESERVA.COD_FUNC = F.COD_FUNC
WHERE HOSPEDE.NOME ILIKE 'JOÃO%'

UNION 

SELECT F.NOME
FROM RESERVA NATURAL JOIN APARTAMENTO A 
...
SELECT F.NOME
FROM HOSPEDAGEM H NATURAL JOIN APARTAMENTO A 
JOIN CATEGORIA C ON A.COD_CAT = C.COD_CAT 
...
SELECT C.NOME
FROM HOSPEDE NATURAL JOIN RESERVA NATURAL JOIN APARTAMENTO A JOIN CATEGORIA C
ON A.COD_CAT = C.COD_CAT
...
SELECT  C.NOME
FROM HOSPEDE NATURAL JOIN HOSPEDAGEM NATURAL JOIN APARTAMENTO A 
JOIN CATEGORIA C ON A.COD_CAT = C.COD_CAT 
